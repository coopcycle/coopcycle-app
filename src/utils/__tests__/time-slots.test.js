...
describe('humanizeTaskTime', () => {
  ...
  it('returns expected results', () => {
    expect(humanizeTaskTime(task, moment('2019-11-14 14:00:00'))).toEqual(
      'Today between 7:00 PM and 8:00 PM',
    );

    expect(humanizeTaskTime(task, moment('2019-11-13 14:00:00'))).toEqual(
      'Tomorrow between 7:00 PM and 8:00 PM',
    );

    expect(humanizeTaskTime(task, moment('2019-11-12 14:00:00'))).toEqual(
      'Thursday between 7:00 PM and 8:00 PM',
    );

    expect(humanizeTaskTime(task, moment('2019-11-14 19:30:00'))).toEqual(
      'Today between 7:00 PM and 8:00 PM',
    );

    expect(humanizeTaskTime(task, moment('2019-11-13 19:30:00'))).toEqual(
      'Tomorrow between 7:00 PM and 8:00 PM',
    );
  });
});
