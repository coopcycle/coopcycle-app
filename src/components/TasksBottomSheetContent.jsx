...
import { taskAdapter } from '../shared/logistics/redux';
        ...
        <View style={{ paddingHorizontal: 16, paddingVertical: 8 }}>
          ...
          <BottomSheetFlatList
            ...
            renderItem={({ item }) => {
              ...
              const iconColor = item.type === 'PICKUP' ? '#E53935' : '#4CAF50';

              return (
                <Pressable style={styles.taskRow} onPress={() => navigation.navigate('Task', { item })}>
                  ...
                  <View style={styles.colAssigned}>
                    {item.assignedTo && (
                      <Text style={styles.taskCourier}>{item.assignedTo}</Text>
                    )}
                  </View>
                </Pressable>
              );
