...
const willDiscloseBackgroundPermission = (hasDisclosedBackgroundPermission, didAcceptBackgroundGeolocation) => {
  return new Promise((resolve, reject) => {
    ...
    else if (hasDisclosedBackgroundPermission && didAcceptBackgroundGeolocation) {
      resolve(true)
    }
      ...
      BackgroundGeolocation.ready(
        {
          ...
          backgroundPermissionRationale: {
            ...
            positiveAction: i18n.t(
              'BACKGROUND_PERMISSION_RATIONALE.positiveAction',
            ),
        ...
        bgState => {
          ...
          willDiscloseBackgroundPermission(
            ...
            state.app.didAcceptBackgroundGeolocation
