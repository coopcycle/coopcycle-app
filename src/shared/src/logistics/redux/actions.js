...
export const DEP_BULK_ASSIGNMENT_TASKS_SUCCESS =
...
export const assignTasksFailure = createAction(
  '@logistics/ASSIGN_TASKS_FAILURE',
);
export const assignTasksRequest = createAction(
  '@logistics/ASSIGN_TASKS_REQUEST',
);
export const assignTasksSuccess = createAction(
  '@logistics/ASSIGN_TASKS_SUCCESS',
);

export const assignTasksWithUiUpdateSuccess = createAction(
  '@logistics/ASSIGN_TASKS_WITH_UI_UPDATE_SUCCESS',
);

export const unassignTasksWithUiUpdateSuccess = createAction(
  '@logistics/UNASSIGN_TASKS_WITH_UI_UPDATE_SUCCESS',
);

export const disableCentrifugoUpdateForTasksIds = createAction(
  '@logistics/DISABLE_CENTRIFUGO_UPDATE_FOR_TASKS_IDS',
);
export const disableCentrifugoUpdateForUsers = createAction(
  '@logistics/DISABLE_CENTRIFUGO_UPDATE_FOR_USER',
);
export const restoreCentrifugoUpdate = createAction(
  '@logistics/RESTORE_CENTRIFUGO_UPDATE',
);
...
export const markTaskDoneRequest = createAction(
  '@logistics/MARK_TASK_DONE_REQUEST',
);
export const markTaskDoneSuccess = createAction(
  '@logistics/MARK_TASK_DONE_SUCCESS',
);
export const markTaskDoneFailure = createAction(
  '@logistics/MARK_TASK_DONE_FAILURE',
);

export const markTaskFailedRequest = createAction(
  '@logistics/MARK_TASK_FAILED_REQUEST',
);
export const markTaskFailedSuccess = createAction(
  '@logistics/MARK_TASK_FAILED_SUCCESS',
);
export const markTaskFailedFailure = createAction(
  '@logistics/MARK_TASK_FAILED_FAILURE',
);

export const createTaskListRequest = createAction(
  '@logistics/CREATE_TASK_LIST_REQUEST',
);
export const createTaskListSuccess = createAction(
  '@logistics/CREATE_TASK_LIST_SUCCESS',
);
export const createTaskListFailure = createAction(
  '@logistics/CREATE_TASK_LIST_FAILURE',
);

export const updateTaskListsSuccess = createAction(
  '@logistics/UPDATE_TASK_LIST_SUCCESS',
);
...
export function updateTask(action, task) {
  return function (dispatch, getState) {
    ...
    if (
      ...
      prevState.logistics.ui.disabledCentrifugoUpdatesForTasksIds.includes(
        task['@id'],
      )
    ) {
      return;
