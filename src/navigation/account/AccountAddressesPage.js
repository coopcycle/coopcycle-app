  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        placeholder={ this.props.t('ENTER_NEW_ADDRESS') }
      ...
      />
        {!this.state.focused && <View style={{ flex: 4 }}>
          <Divider/>
          <Heading margin={3}>{ this.props.t('MY_ADDRESSES') }</Heading>
        <FlatList
          ...
          ListEmptyComponent={ <View style={{
            ...
            <Image style={{ width: '50%', margin: 'auto' }} source={require('../../assets/images/no_addresses.png')} resizeMode={'contain'} />
            <Text textAlign="center" color={darkGreyColor}>{ this.props.t('NO_ADDRESS_SAVED_YET') }</Text>
          </View>}
