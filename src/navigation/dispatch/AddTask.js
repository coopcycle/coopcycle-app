        ...
        <VStack>
          <FormControl style={[styles.formRow, { flexDirection: 'row' }]}>
            ...
            <Button
              ...
              ml="1"
              {...dropoffBtnProps}
              onPress={() => this.setState({ type: 'DROPOFF' })}>
              Dropoff
            </Button>
          </FormControl>
          <FormControl style={styles.formRow}>
            <FormControl.Label style={{ marginBottom: 50 }}>
              {this.props.t('TASK_FORM_ADDRESS_LABEL')}
            </FormControl.Label>
          </FormControl>
          <FormControl
            style={[styles.autocompleteContainer, { marginTop: 85 }]}>
            <AddressAutocomplete
              ...
              renderRight={() => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      navigate('DispatchEditAddress', {
                        address,
                        onSubmit: this._onEditAddressSubmit.bind(this),
                      })
                    }>
          ...
          <FormControl style={styles.formRow}>
            <FormControl.Label>
              {this.props.t('TASK_FORM_DONE_AFTER_LABEL')}
            </FormControl.Label>
            <HStack>
              <View style={styles.datePickerRow}>
                ...
                <Button
                  size="sm"
                  onPress={() =>
                    this.setState({ isDoneAfterDateTimePickerVisible: true })
                  }>
                  {this.props.t('EDIT')}
                </Button>
              </View>
          ...
          <FormControl style={styles.formRow}>
            <FormControl.Label>
              {this.props.t('TASK_FORM_DONE_BEFORE_LABEL')}
            </FormControl.Label>
            <HStack>
              <View style={styles.datePickerRow}>
                ...
                <Button
                  size="sm"
                  onPress={() =>
                    this.setState({ isDoneBeforeDateTimePickerVisible: true })
                  }>
                  {this.props.t('EDIT')}
                </Button>
              </View>
          ...
          <FormControl style={styles.formRow}>
            <FormControl.Label>
              {this.props.t('TASK_FORM_COMMENTS_LABEL')}
            </FormControl.Label>
            <View>
              <TextArea
                rowSpan={5}
