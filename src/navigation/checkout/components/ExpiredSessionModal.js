      ...
      <Modal
        ...
        <View style={ styles.modalContent }>
          <View style={ styles.modalText }>
            <Text style={{ color: '#a94442', textAlign: 'center' }}>{ this.props.t('SESSION_EXPIRED') }</Text>
          </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(ExpiredSessionModal))
