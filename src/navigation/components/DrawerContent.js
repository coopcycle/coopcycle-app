...
const RestaurantsDrawerItem = ({ restaurants, t, navigate }) => {
...
const StoresDrawerItem = ({ stores, t, navigate }) => {
  if (stores.length === 1) {
          ...
          <View style={ styles.content }>
            <DrawerContentScrollView {...this.props}>
              ...
              { (isAuthenticated && (user.hasRole('ROLE_ADMIN') || user.hasRole('ROLE_RESTAURANT')) && restaurants.length > 0) && (
                <RestaurantsDrawerItem restaurants={ restaurants } t={ this.props.t } navigate={ this.props.navigation.navigate } />
              ) }
              { (isAuthenticated && user.hasRole('ROLE_STORE') && stores.length > 0) && (
                <StoresDrawerItem stores={ stores } t={ this.props.t } navigate={ this.props.navigation.navigate } />
              ) }
            </DrawerContentScrollView>
          </View>
